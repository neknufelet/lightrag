...
//
// ## ⚠ 擋的是「翻譯本」，不是「中文」（PO 2026-08-19 裁）
//
// 這裡只看**標題、檔名、標籤**，從來沒有打開 PDF 看內容。所以：
//
//     PDF_ZHT ／ …_zh-TW_dual.pdf ／ BabelDOC 標籤   → 擋（是翻譯本）
//     《吸声材料新进展》這種原生中文論文              → **照送**
//
// PO 原話：「不用擋，也要收」。原生中文文獻是內容，不是翻譯副本 ——
// **不要在這裡加「內容是中文就不收」的判斷**。真要那樣做也不在這一層：
// 這一層看不到文字，要等解析之後才判得出來。
